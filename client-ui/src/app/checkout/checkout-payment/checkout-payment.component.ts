...
export class CheckoutPaymentComponent implements AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit() {
    this.stripe = Stripe(
      'pk_test_51Hg6wQBMOm4bVxPaU8BVR0qZN1ttxXi5N1jW88bwe2DnVVzJ2SGf4dUWA54ugFSb83gN7bpxwdwByeMl9RjfRmmk00v20RsE7B'
    );
  ...
  async submitOrder() {
    ...
    try {
      ...
      // wait for the return payment intent as promise
